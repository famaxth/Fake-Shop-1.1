...
def send_otziv(message):
    if message.text == 'Покупки':
        ...
        if message.chat.id == config.admin_id:
            bot.send_message(config.admin_id, "Админ панель",
        ...
        print("Выбрал г. Москва. ID: "+str(message.chat.id) +
              '    Дата/время: '+str(datetime.now()))
        bot.send_message(
            message.chat.id, 'Какой район интересует?', reply_markup=menu.rayon_msk)
    elif message.text == 'Санкт-Петербург':
        print("Выбрал г. Санкт-Петербург. ID: "+str(message.chat.id) +
              '    Дата/время: '+str(datetime.now()))
        bot.send_message(
            message.chat.id, 'Какой район интересует?', reply_markup=menu.rayon_spb)
    elif message.text == 'Екатеринбург':
        print("Выбрал г. Екатеринбург. ID: "+str(message.chat.id) +
              '    Дата/время: '+str(datetime.now()))
        bot.send_message(
            message.chat.id, 'Какой район интересует?', reply_markup=menu.rayon_ekb)
        ...
        print("Выбрал г. Зеленоград. ID: "+str(message.chat.id) +
              '    Дата/время: '+str(datetime.now()))
        bot.send_message(message.chat.id, 'Какой район интересует?',
                         reply_markup=menu.rayon_perm)
